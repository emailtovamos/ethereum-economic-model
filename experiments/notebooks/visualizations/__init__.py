...
legend_state_variable_name_mapping = {
    ...
    "total_realized_mev_to_validators_aa_independent": "aa MEV independent",
    "total_realized_mev_to_validators_aa_independent_cumulative": "cumulative aa mev independent",
